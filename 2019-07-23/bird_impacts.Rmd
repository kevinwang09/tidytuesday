...
```{r}
table(is.na(raw_data$cost_repairs_infl_adj))
summary(raw_data$cost_repairs_infl_adj)
hist(raw_data$cost_repairs_infl_adj)

complete_cost_data = raw_data %>% 

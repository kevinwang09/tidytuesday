...
**One key thing that I learnt**: `ggpubr` provides very nice colour palettes (e.g. Lancet, NEJM) that are somewhat in line with what these journals expect in their publications. The `ggiraph` package has received some very powerful updates since the last time I used it in 2016. I would even go as far as to say it has better aesthetics than `plotly` in certain areas. 

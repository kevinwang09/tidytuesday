...
This is my own personal project. The idea is to scrape the HSC scaling data from UAC published PDF. See the script for download [here](hsc/download_UAC.R), analysis will be made available later. 
...
<img src="2019-08-13/boxplot_reign.png" width="800" height="600" />
...
<img src="2019-08-13/surv_plot_emperor_rise.png" width="600" height="400" />
...
<img src="2019-08-13/timeline_plot.png" width="1000" height="800" />  

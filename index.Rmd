...
The main reasons that I am doing this challenge: 
  ...
  1. Create a repository of code snippets. Due to the ethics restriction of the research that I do, I cannot always share codes from my own research but I can always apply the same code to different data. 
